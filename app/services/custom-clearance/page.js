        ...
        <div className="relative">
            ...
            <div className="absolute bg-black bg-opacity-70 inset-0 flex flex-col items-center justify-center">
                <div className="flex flex-col w-[70%]">
                    <h1 className="text-white md:mt-12 text-2xl md:text-2xl font-bold">RELIABLE, COST EFFECTIVE AND TIMELY SERVICE</h1>
                    <p className="text-white max-w-3xl text-sm md:text-xl mt-4">We provide comprehensive solutions with reliablity to enhance the customers satisfaction and experience</p>
                </div>
            </div>
        </div>
